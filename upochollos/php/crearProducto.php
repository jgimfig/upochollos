...
<div id="producto">
    <form action="crud.php" method="post" enctype="multipart/form-data"  class="grid-container" onsubmit="return comprobarProducto();">
        <div class="nombreDiv ip2 col-sm-4">
            Intoducir nombre del producto<br><br><input type="text" id="nombre" name="nombreInput" class="ip"  required/>
        </div>
        <div class="enlaceDiv ip2 col-sm-4">
            Intoducir enlace<br><br><input type="url" id="enlace" name="enlaceInput" class="ip"  required/>
        </div>
        <div class="descripcionDiv ip2 col-sm-4">
            Intoducir descripción del producto<br><br><textarea id="descripcion" name="descripcionInput" rows="4" cols="50" class="ip"  required></textarea>
        </div>
