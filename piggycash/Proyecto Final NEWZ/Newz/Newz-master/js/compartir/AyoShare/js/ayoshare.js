 ...
 * https://github.com/Newz/jQuery-Awesome-Sosmed-Share-Button
...
function ayo_share_og(c, s) {
    ...
    if (window.location.href == c) {
        ...
        if (s == 'facebook') {
            window.open('https://www.facebook.com/sharer/sharer.php?u=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'google') {
            window.open('https://plus.google.com/share?url=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'linkedin') {
            window.open('https://www.linkedin.com/shareArticle?mini=true&url=' + c + '&title=' + tit + '&summary=' + des, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'reddit') {
            window.open('http://reddit.com/submit?url=' + c + '&title=' + tit + '+-+via @Newz', 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'pinterest') {
            window.open('http://pinterest.com/pin/create/button/?url=' + c + '&media=' + img + '&description=' + des, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'stumbleupon') {
            window.open('http://www.stumbleupon.com/badge/?url=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'bufferapp') {
            window.open('https://bufferapp.com/add?url=' + c + '&text=' + des, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'vk') {
            window.open('http://vk.com/share.php?url=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'pocket') {
            window.open('https://getpocket.com/save?title=' + tit + '&url=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'twitter') {
            window.open('https://twitter.com/share?text=' + tit + '+-+via @Newz&url=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'flipboard') {
            window.open('https://share.flipboard.com/bookmarklet/popout?v=2&title=' + tit + '&url=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'digg') {
            window.open('http://digg.com/submit?url=' + c, 'Newz.com', 'width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');
        } else if (s == 'whatsapp') {
